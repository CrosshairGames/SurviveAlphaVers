...
public class MeleeWeaponItem : WeaponItem
{
    ...
    public override Usability CanUse(PlayerHotbar hotbar, int hotbarIndex, Vector3 lookAt)
    {
        ...
        return NetworkTime.time >= hotbar.usageEndTime && hotbar.GetComponent<PlayerReloading>().ReloadTimeRemaining() == 0
               ? Usability.Usable
               : Usability.Cooldown;
    }
    ...
    Health SphereCastToLookAt(GameObject go, Collider collider, Vector3 lookAt, out RaycastHit hit)
    {
        ...
        // -> raycast is too small, e.g. if we aim above a zombie's shoulder
        ...
        //    if there's a door between us and the zombie, we shouldn't hit it.
