    ...
    public class ActionFPSCamera : IAction
	{
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
        {
            ...
            if (motor != null && motor.cameraMotorType.GetType() == typeof(CameraMotorTypeFixed))
            {
                ...
                fpsMotor.hidePlayerModel = this.hidePlayerModel; 
            }
        ...
        private SerializedProperty spHidePlayer;
		...
		protected override void OnEnableEditorChild ()
		{
            ...
            this.spHidePlayer = this.serializedObject.FindProperty("hidePlayerModel");
		}
		...
		public override void OnInspectorGUI()
		{
            ...
            EditorGUILayout.PropertyField(this.spHidePlayer);
