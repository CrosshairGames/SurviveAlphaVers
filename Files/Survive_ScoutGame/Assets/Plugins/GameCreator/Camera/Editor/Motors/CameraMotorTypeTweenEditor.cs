namespace GameCreator.Camera
{
	...
	public class CameraMotorTypeTweenEditor : ICameraMotorTypeEditor 
	{
        ...
        private const string PROP_ALLOWLOOKAT = "allowLookAt";
        ...
        private SerializedProperty spAllowLookAt;
		...
		protected override void OnSubEnable()
		{
            ...
            this.spAllowLookAt = serializedObject.FindProperty(PROP_ALLOWLOOKAT);
		...
		protected override bool OnSubInspectorGUI (Transform cameraMotorTransform)
		{
            ...
            EditorGUILayout.PropertyField(this.spAllowLookAt);
            EditorGUI.BeginDisabledGroup(!this.spAllowLookAt.boolValue);
