namespace GameCreator.Core
{
    ...
    public class ActionVariablesAssignTransform : IActionVariablesAssign
	{
		...
		public override void ExecuteAssignement(GameObject target)
		{
            ...
            {
                case ValueFrom.Invoker: this.variable.Set(target.transform, target); break;
                case ValueFrom.Player : this.variable.Set(HookPlayer.Instance.transform, target); break;
