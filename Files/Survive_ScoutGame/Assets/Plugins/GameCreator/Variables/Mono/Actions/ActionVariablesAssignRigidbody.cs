namespace GameCreator.Core
{
    ...
    public class ActionVariablesAssignRigidbody : IActionVariablesAssign
	{
		...
		public override void ExecuteAssignement(GameObject target)
		{
            ...
            {
                case ValueFrom.Invoker: this.variable.Set(target.GetComponent<Rigidbody>(), target); break;
                case ValueFrom.Player : this.variable.Set(HookPlayer.Instance.GetComponent<Rigidbody>(), target); break;
