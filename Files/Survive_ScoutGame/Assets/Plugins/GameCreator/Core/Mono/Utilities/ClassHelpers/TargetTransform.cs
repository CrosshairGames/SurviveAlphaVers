namespace GameCreator.Core
{
	...
	public class TargetTransform
	{
        ...
        public Transform GetTransform(GameObject invoker)
		{
            ...
            case Target.Camera:
                if (HookCamera.Instance != null) result = HookCamera.Instance.transform;
                break;
			...
			case Target.Transform:
                result = this.transform.GetValue(invoker);
				break;
			}
		...
		public override string ToString ()
		{
            ...
            case Target.Transform: result = this.transform.ToString(); break;
            }
