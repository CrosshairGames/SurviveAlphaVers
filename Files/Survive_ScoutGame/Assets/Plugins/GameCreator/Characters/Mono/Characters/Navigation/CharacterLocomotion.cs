namespace GameCreator.Characters
{
	...
	public class CharacterLocomotion
	{
		...
		private const float JUMP_COYOTE_TIME = 0.2f;
        ...
        private LOCOMOTION_SYSTEM currentLocomotionType = LOCOMOTION_SYSTEM.CharacterController;
        ...
        public void SetTarget(Ray ray, LayerMask layerMask, ILocomotionSystem.TargetRotation rotation = null, UnityAction callback = null)
		{
			this.ChangeLocomotionSystem<LocomotionSystemTarget>();
            ((LocomotionSystemTarget)this.currentLocomotionSystem).SetTarget(ray, layerMask, rotation, callback);
		}
		...
		private void UpdateCharacterState(LOCOMOTION_SYSTEM locomotionSystem)
		{
            ...
            this.character.characterState.isSliding = isSliding;
