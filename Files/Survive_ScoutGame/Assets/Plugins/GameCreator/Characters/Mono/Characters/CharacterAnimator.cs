namespace GameCreator.Characters
{
	...
	public class CharacterAnimator : MonoBehaviour 
	{
        ...
        public string jumpChain = "JumpChain";
        ...
        private int paramHashIsSliding;
        ...
        private int paramHashJumpChain;
		...
		private void Awake()
		{
            ...
            this.paramHashIsSliding = Animator.StringToHash(this.isSliding);
            ...
            this.paramHashJumpChain = Animator.StringToHash(this.jumpChain);
        ...
        private void Update()
		{
            ...
            this.animator.SetBool(this.paramHashIsSliding, state.isSliding);
		...
		{
            this.animator.SetInteger(this.paramHashJumpChain, jumpChain);
